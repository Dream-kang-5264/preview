...
export const AssistantMessageContent = ({
  ...
  return (
    <div className="flex flex-col">
      <Section title="总结" animate={isStreaming} streaming={isStreaming}>
        {content ? (
      ...
      <Section title="来源" animate={isStreaming}>
      ...
      <Section title="图片" animate={isStreaming}>
      ...
      {related_queries && related_queries.length > 0 && (
        <Section title="相关" animate={isStreaming}>
          <RelatedQuestions
