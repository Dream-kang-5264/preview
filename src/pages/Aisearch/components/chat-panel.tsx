      ...
      {messages.length > 0 || threadId ? (
        isLoading ? (
          ...
          <div ref={messagesRef} className="pt-10 w-full relative">
            ...
            <div
              ...
              className="bottom-0 fixed px-2 max-w-screen-md justify-center items-center md:px-2 pb-12"
              style={{ width: `${width}px`, backdropFilter: 'blur(5px)', }}
            >
        ...
        <div className="w-full flex flex-col justify-center items-center">
          <div className="flex items-center justify-center mb-8">
            <span className="text-3xl">AI搜索</span>
          </div>
