import { Button, Col, ConfigProvider, Empty, Input, Modal, Pagination, Row, Space, Table, TableColumnsType, Tooltip, message } from 'antd'
...
function index() {
    ...
    const columns: TableColumnsType<DataType> = [
        ...
        // },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    <a onClick={() => handleContent(record)}>查看</a>
                    <a onClick={() => {
        ...
        <div className={styles.PublicMaterial}>
            ...
            <div className={styles.search_content}>
                ...
                <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} cancelText={'取消'} okText={'复制'}>
                    <div className={styles.search_modal} style={{ marginTop: '1.5vw', border: '1px solid #ccc', borderRadius: '1vh' }} ><div style={{ padding: '', }}>{modalContent}</div></div>
                </Modal>
            </div>
            {contextHolder}
            {/* <Table<DataType> rowSelection={rowSelection} columns={columns} dataSource={tableData} /> */}
            {/* 分页 */}
